...
if ('/Applications/MAMP/bin/php/php8.0.3/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/Applications/MAMP/bin/php/php8.0.3/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
