...
class __Mustache_92cafa3d9ca5fee917916181324fcedf extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF4f86384f15aa954a4db418a87fb3520($context, $indent, $value);
...
';
    ...
    private function sectionF4f86384f15aa954a4db418a87fb3520(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '\', \'_blank\')" class="btn btn-icon bg-primary text-white icon-no-margin btn-footer-communication" aria-label="';
                $value = $context->find('str');
